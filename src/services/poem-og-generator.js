...
const {
  escapeXml,
  formatOccasion: _formatOccasion,
...
/** Poem-specific occasion labels (i_love_you -> "Love", fallback -> "Poem") */
function formatOccasion(occasion) {
  if (occasion === "i_love_you") return "Love";
  return _formatOccasion(occasion, "Poem");
}
