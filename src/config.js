...
const HOST_ALLOWLIST_MODE = (
  process.env.HOST_ALLOWLIST_MODE ||
  (process.env.NODE_ENV === "production" ? "report" : "off")
).toLowerCase();
const HOST_ALLOWLIST = process.env.HOST_ALLOWLIST || "";
const ADMIN_UI_MODE = (process.env.ADMIN_UI_MODE || "public").toLowerCase();
const ADMIN_UI_ALLOWED_EMAILS = process.env.ADMIN_UI_ALLOWED_EMAILS || "";
const CLOUDFLARE_ACCESS_AUD = process.env.CLOUDFLARE_ACCESS_AUD || "";
const CLOUDFLARE_ACCESS_ISSUER = process.env.CLOUDFLARE_ACCESS_ISSUER || "";
const CLOUDFLARE_ACCESS_CERTS_URL =
  process.env.CLOUDFLARE_ACCESS_CERTS_URL ||
  (CLOUDFLARE_ACCESS_ISSUER
    ? `${CLOUDFLARE_ACCESS_ISSUER.replace(/\/$/, "")}/cdn-cgi/access/certs`
    : "");
...
module.exports = {
  ...
  SUNO_PERSONA_GENERATE_MAX_ATTEMPTS,
  SUNO_PERSONA_GENERATE_RETRY_DELAY_MS,
  MUSIC_PROVIDER,
  HF_TOKEN,
  DEFAULT_VOICE_MODE,
