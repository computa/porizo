...
const STYLES = {
  ...
  afrobeats: {
    ...
    keys: ["Eb", "Bb", "F", "Ab"],
    energy: "high",
    reference_artists: ["Burna Boy", "Wizkid", "Davido"],
  ...
  highlife: {
    ...
    keys: ["F", "Bb", "C", "G"],
    energy: "medium",
    reference_artists: ["E.T. Mensah", "Nana Ampadu", "Pat Thomas"],
  ...
  igbo_highlife: {
    ...
    keys: ["F", "Bb", "C", "G"],
    energy: "medium",
    reference_artists: ["Oliver De Coque", "Stephen Osita Osadebe", "Oriental Brothers"],
    prompt: "Igbo Highlife, West African highlife, 12/8 compound groove, lilting swinging feel, clean melodic electric guitar arpeggios, Congolese rumba guitar style, soukous-influenced guitar runs, walking bass line, trumpet and saxophone brass accents, celebratory Igbo praise-singing vocals, warm vintage analog production",
    genre_core: "Eastern Nigerian Igbo Highlife groove",
    instrument_palette: ["clean electric guitar", "trumpet", "saxophone", "walking bass", "conga", "metal bell"],
    rhythmic_signature: "Lilting 12/8 compound groove with fluid clean guitar arpeggios, walking bass, and hand percussion pulse",
    arrangement_notes: "Guitar-led celebratory groove, fluid Congolese rumba-style arpeggios, brass responses, warm vintage production",
    ...
    suno: {
      support: "weak",
      instruction_override: "Oliver De Coque style, Igbo Highlife, West African highlife, 12/8 compound groove, lilting swinging feel, clean melodic electric guitar arpeggios, Congolese rumba guitar style, soukous-influenced fluid cascading guitar runs, walking bass, trumpet and saxophone brass, celebratory Igbo praise-singing, warm vintage 1970s production, Nigerian Eastern highlife",
      negative_constraints: [
        "drum kit",
        "synth pads",
    ...
    elevenlabs: {
      support: "medium",
      instruction_override: "Igbo Highlife, fluid clean guitar arpeggios, soukous-influenced runs, brass section, lilting 12/8 groove, warm celebratory feel.",
      negative_constraints: [],
    },
  },
  ...
  ogene: {
    ...
    keys: ["G", "C", "D"],
    energy: "high",
    reference_artists: ["Flavour N'abania", "Umu Obiligbo"],
    prompt: "Igbo ceremonial festival music, interlocking iron gong bell patterns in 6/8 compound time, gamelan-style metallic percussion ensemble, high-pitched wailing ethnic flute melody, clay pot bass drum pulse, dense hand drum polyrhythms, communal call-and-response chanting, festival procession energy",
    genre_core: "Traditional Nigerian Ogene ceremonial groove",
    instrument_palette: ["iron gong bells", "ethnic flute", "clay pot drum", "hand drums", "shaker"],
    rhythmic_signature: "Interlocking iron gong bell patterns in 6/8 with clay pot bass pulse and hand drum polyrhythms",
    arrangement_notes: "Percussion-first with high-pitched flute melody weaving over interlocking metallic patterns, festival energy",
    ...
    suno: {
      support: "weak",
      instruction_override: "Igbo ceremonial festival music, gamelan-style interlocking iron gong bell percussion in 6/8 compound time, high-pitched wailing bamboo flute melody, dense hand drum polyrhythms, communal call-and-response group chanting, raw outdoor festival procession energy, West African traditional folk percussion ensemble",
      negative_constraints: [
        "electric guitar",
        "synth pads",
        "drum kit",
    ...
    elevenlabs: {
      support: "medium",
      instruction_override: "Igbo ceremonial percussion, interlocking iron gong bell patterns, wailing high flute, dense hand drum polyrhythms, group chant responses, festival procession energy.",
      negative_constraints: ["trap hi-hat programming", "EDM risers"],
    },
  },
  ...
  juju: {
    ...
    keys: ["A", "D", "E"],
    energy: "medium",
    reference_artists: ["King Sunny Ade", "Ebenezer Obey"],
    prompt: "Nigerian Juju music, hypnotic interlocking clean electric guitars, pedal steel guitar melody, talking drum percussion, shekere gourd rattle, soukous-influenced guitar runs, sinuous swaying rhythm, spacious texture, call and response praise vocals, vintage 1970s dance-band warmth",
    genre_core: "Yoruba Juju dance-band feel",
    instrument_palette: ["lead guitar", "rhythm guitar", "pedal steel guitar", "talking drum", "shekere", "conga"],
    rhythmic_signature: "Hypnotic interlocking clean electric guitar patterns with talking drum chatter and rolling shekere groove",
    arrangement_notes: "Guitar-led hypnotic groove, pedal steel weaving between guitars, spacious texture with open holes, layered percussion",
    ...
    suno: {
      support: "weak",
      instruction_override: "King Sunny Ade style, Nigerian Juju music, hypnotic interlocking clean electric guitars, pedal steel guitar melody, talking drum percussion, shekere gourd rattle, soukous-influenced guitar runs, sinuous swaying 4/4 groove with 12/8 feel, spacious dub-like texture, praise-singing call and response vocals, vintage 1970s warmth",
      negative_constraints: [
        "drum kit",
        "synth pads",
        "afrobeats kick-snare bounce",
    ...
    elevenlabs: {
      support: "medium",
      instruction_override: "Nigerian Juju, hypnotic interlocking guitar lines, pedal steel melody, talking drum, shekere, celebratory praise-singing dance groove.",
      negative_constraints: [],
    },
  },
  ...
  fuji: {
    ...
    keys: ["D", "G", "A"],
    energy: "high",
    reference_artists: ["Kollington Ayinla", "KWAM 1", "Wasiu Ayinde Marshal"],
    prompt: "Nigerian Fuji music, dense talking drum (dundun) polyrhythmic ensemble, agogo iron bell timeline, shekere gourd rattle, fast driving 12/8 groove, energetic Yoruba praise-chant vocals, percussion-dominated street-band energy, raw festival feel",
    genre_core: "Nigerian Fuji percussive street-band energy",
    instrument_palette: ["talking drum (dundun)", "agogo bell", "shekere", "frame drum", "hand drums"],
    rhythmic_signature: "Dense talking drum polyrhythmic ensemble with agogo bell timeline and fast driving 12/8 groove",
    arrangement_notes: "Relentless rhythmic momentum, talking drums leading, Yoruba chant cadence, percussion-dominated",
    vocal_character: { male: "energetic rapid-fire Yoruba praise-chant male vocal", female: "energetic rapid-fire Yoruba praise-chant female vocal" },
    suno: {
      support: "weak",
      instruction_override: "KWAM 1 style, Nigerian Fuji music, dense talking drum (dundun) polyrhythmic ensemble, agogo iron bell timeline, shekere gourd rattle, fast driving 12/8 groove, 120 BPM, energetic Yoruba praise-chant vocals, percussion-dominated street-band energy, West African Muslim devotional folk music, apala-influenced",
      negative_constraints: [
        "electric guitar",
        "synth pads",
        "drum kit",
    ...
    elevenlabs: {
      support: "medium",
      instruction_override: "Nigerian Fuji, dense talking drum polyrhythms, agogo iron bell, shekere, fast driving groove, rapid-fire Yoruba praise-chant vocals.",
