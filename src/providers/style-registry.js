...
const STYLES = {
  ...
  ogene: {
    ...
    keys: ["G", "C", "D"],
    energy: "high",
    prompt: "Nigerian Ogene, metallic ogene bell ostinato, slit drum pulse, interlocking percussion, Igbo festival procession groove, communal call-and-response chanting, sparse harmonic bed, raw traditional ensemble",
    ...
    rhythmic_signature: "Interlocking metallic ogene bell ostinato with slit-drum pulse and communal chant cadence",
    arrangement_notes: "Percussion-first structure with chant-ready hook motifs and procession momentum",
    vocal_character: { male: "powerful communal male chant vocal", female: "strong communal female chant vocal" },
    suno: {
      support: "weak",
      instruction_override: "Nigerian Ogene, metallic ogene bell ostinato, slit drum pulse, interlocking percussion patterns, Igbo festival procession groove, communal call-and-response chanting, sparse harmonic bed, raw traditional ensemble energy",
      negative_constraints: [
        "glossy afropop synth stacks",
        "highlife guitar-led lead phrasing",
        "dembow/reggaeton rhythm",
      ],
    },
    elevenlabs: {
      support: "medium",
  ...
  juju: {
    ...
    keys: ["A", "D", "E"],
    energy: "medium",
    prompt: "Yoruba Juju music, interlocking electric guitars, talking drum lead, shekere rhythm, call and response vocals, celebratory dance groove, layered percussion ensemble, Nigerian dance-band energy",
    genre_core: "Yoruba Juju dance-band feel",
    instrument_palette: ["lead guitar", "rhythm guitar", "talking drum", "shekere", "accordion"],
    rhythmic_signature: "Syncopated interlocking electric guitar patterns over talking drum lead rhythm and rolling hand percussion",
    arrangement_notes: "Keep groove celebratory, guitar-led, and dance-forward with layered rhythmic movement",
    vocal_character: { male: "warm praise-singing male vocal", female: "warm praise-singing female vocal" },
    suno: {
      support: "weak",
      instruction_override: "Yoruba Juju music, interlocking electric guitar patterns, talking drum lead rhythm, shekere percussion, celebratory dance groove, call and response phrasing, layered percussion ensemble, Nigerian dance-band energy",
      negative_constraints: ["afrobeats kick-snare bounce as the core groove"],
    },
    elevenlabs: {
      support: "medium",
  ...
  fuji: {
    ...
    keys: ["D", "G", "A"],
    energy: "high",
    prompt: "Nigerian Fuji, talking drum drive, sakara drum patterns, dense polyrhythmic percussion layers, energetic Yoruba chant vocal cadence, street-band energy, percussion-dominated ensemble, raw festival feel",
    genre_core: "Nigerian Fuji percussive street-band energy",
    instrument_palette: ["talking drum", "sakara drum", "agogo bell", "auxiliary percussion"],
    rhythmic_signature: "Dense polyrhythmic pulse led by talking drum drive and sakara drum patterns",
    arrangement_notes: "Relentless rhythmic momentum with controlled breaks and Yoruba chant cadence",
    vocal_character: { male: "energetic Yoruba chant male vocal", female: "energetic Yoruba chant female vocal" },
    suno: {
      support: "weak",
      instruction_override: "Nigerian Fuji, talking drum drive, sakara drum patterns, dense polyrhythmic percussion layers, energetic Yoruba chant vocal cadence, street-band energy, percussion-dominated ensemble, raw festival feel",
      negative_constraints: ["pop four-on-the-floor beat", "melodic synth leads"],
    },
    elevenlabs: {
      support: "medium",
  ...
  igbo_highlife: {
    ...
    keys: ["F", "Bb", "C", "G"],
    energy: "medium",
    prompt: "Eastern Nigerian Highlife, Igbo guitar patterns, trumpet brass, ogene bell accents, festive dance groove, celebratory Igbo praise feel, warm analog production",
    genre_core: "Eastern Nigerian Igbo Highlife groove",
    instrument_palette: ["highlife guitar", "trumpet", "ogene bell", "conga", "walking bass"],
    rhythmic_signature: "Buoyant Igbo guitar patterns with ogene bell accents and hand percussion pulse",
    arrangement_notes: "Celebratory Igbo praise feel with bright guitar patterns and brass accents",
    vocal_character: { male: "warm celebratory Igbo male vocal", female: "warm celebratory Igbo female vocal" },
    suno: {
      support: "weak",
      instruction_override: "Eastern Nigerian Highlife, Igbo guitar arpeggio patterns, trumpet brass accents, ogene bell highlights, festive dance groove, celebratory Igbo praise vocal feel, warm analog production, vintage highlife sound",
      negative_constraints: ["modern trap production", "EDM synth drops", "Ghanaian hiplife beat"],
    },
    elevenlabs: {
      support: "medium",
      instruction_override: "Eastern Nigerian Igbo Highlife with bright guitar patterns, brass, and celebratory feel.",
      negative_constraints: [],
    },
  },
