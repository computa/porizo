...
ALTER TABLE entitlements ADD COLUMN IF NOT EXISTS poems_remaining INTEGER NOT NULL DEFAULT 0;
ALTER TABLE entitlements ADD COLUMN IF NOT EXISTS poems_allowance INTEGER NOT NULL DEFAULT 0;
ALTER TABLE entitlements ADD COLUMN IF NOT EXISTS poems_used_total INTEGER NOT NULL DEFAULT 0;
