...
ALTER TABLE gift_orders ADD COLUMN IF NOT EXISTS content_snapshot_json TEXT;
ALTER TABLE gift_orders ADD COLUMN IF NOT EXISTS next_retry_at TEXT;
ALTER TABLE gift_orders ADD COLUMN IF NOT EXISTS dispatch_started_at TEXT;
