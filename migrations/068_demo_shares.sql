...
ALTER TABLE share_tokens ADD COLUMN share_type TEXT NOT NULL DEFAULT 'normal';
ALTER TABLE poem_share_tokens ADD COLUMN share_type TEXT NOT NULL DEFAULT 'normal';
