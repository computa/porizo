...
struct MemoryQuestion: Codable, Identifiable {
    let id: String
    let question: String
...
struct MemoryQuestionsResponse: Codable {
    let questions: [MemoryQuestion]
}

/// Request body for POST /memory/questions
struct MemoryQuestionsRequest: Encodable {
    let memory: String
    let occasion: String?
...
struct GenerateLyricsResponse: Codable {
    let lyrics: Lyrics?
    let lyricsStatus: String?
...
struct ApproveLyricsResponse: Codable {
    let approved: Bool
    let lyricsStatus: String?
...
struct RenderPreviewResponse: Codable {
    let jobId: String?
    let estimatedCompletionSec: Int?
    let pollUrl: String?
