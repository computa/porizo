...
| 4 | D (Metadata) | TestFlight notes mention "Poems feature coming soon" which signals incomplete functionality if visible during review. | `marketing/appstore/docs/review-and-submission/description.md:111` | Remove "coming soon" from version notes — poems feature appears implemented. |
| 5 | F (5.1.1 Account) | Demo account credentials reference `reviewer@porizo.co` but actual password is not documented. | `marketing/appstore/docs/review-and-submission/description.md:268-269` | Create the actual demo account on backend and document real password in App Store Connect review notes. |
