...
/**
 * IntroVideoV2 — honest positioning.
 * No voice-clone claims: the promise is a real song made from THEIR story, in minutes.
 */
  ...
  return (
    <AbsoluteFill style={{ background: colors.background }}>
      <Audio
        ...
        volume={interpolate(frame, [0, 15, 1120, 1200], [0, 0.45, 0.45, 0], {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp",
        })}
      />
      ...
      <PopText
        text="Think about someone you love."
        startAt={8}
        duration={55}
        fontSize={38}
        color={colors.textPrimary}
      ...
      <Fade startAt={240} endAt={360} fadeIn={15} fadeOut={15}>
        <AbsoluteFill>
          <PopText
            text="Some feelings are too big"
            startAt={260}
            duration={85}
            fontSize={42}
            y={-30}
      ...
      {/* Step 3: A real song, minutes later */}
          ...
          >
            <ChatMessage
              ...
              linkPreview={{
                ...
                subtitle: "porizo.co/share",
              }}
            />
            <ChatMessage
              text="You put our whole story in a song 😭"
              sender="Mom"
              isMe={false}
              startAt={770}
            />
      ...
      <Fade startAt={820} endAt={920} fadeIn={8} fadeOut={10}>
        ...
        >
          ...
          >
            <ChatMessage
              text="you made me a SONG??"
              sender="Amara"
              isMe={false}
              startAt={838}
            />
            <ChatMessage
              text="Pick me up at 8 :)"
              sender="Amara"
              isMe={false}
              startAt={873}
            />
      ...
      <Fade startAt={910} endAt={1010} fadeIn={8} fadeOut={10}>
        ...
        >
          ...
          >
            ...
            />
            <ChatMessage
              text="THERE'S A SONG ABOUT OUR ROAD TRIP"
              sender="Tyler"
              isMe={false}
              startAt={950}
            />
            <ChatMessage
              text="yo get on FaceTime RIGHT NOW"
              sender="Marcus"
              isMe={false}
              startAt={975}
            />
      ...
      <Fade startAt={1080} endAt={1200} fadeIn={12} fadeOut={3}>
        <AbsoluteFill>
          ...
          <EndCard tagline="Song Gift Maker" startAt={1088} />
        </AbsoluteFill>
      </Fade>
    </AbsoluteFill>
  );
