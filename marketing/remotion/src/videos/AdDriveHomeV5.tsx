...
/**
 * "The Drive Home" V5 — 50s (1500 frames @ 30fps)
 *
 ...
 *   1650-1740: "She recorded it in 2 minutes" reveal
 *   1740-1800: End card: Porizo logo + CTA
 *
 * The HeyGen video is 42s. We extend with our branded end sequence to 50s total.
 */

export const AdDriveHomeV5: React.FC = () => {
  const frame = useCurrentFrame();

  // HeyGen video ends at frame 1260 (42s * 30fps)
  const heygenEnd = 1650;
  ...
  return (
    <AbsoluteFill style={{background: '#0A0604'}}>
      ...
      <OffthreadVideo
        src={staticFile('stock/drive-home/heygen-base-v2.mp4')}
        volume={0}
      ...
      {/* ═══ WATERMARK COVER: Porizo badge over HeyGen logo — bottom-right ═══ */}
      <Fade startAt={0} endAt={heygenEnd} fadeIn={10} fadeOut={10}>
        <div style={{
          ...
          <div style={{
            fontFamily: fonts.body, fontSize: 11, color: '#FFFFFF', opacity: 0.7,
          }}>
            App Store
          </div>
        </div>
      ...
      {/* ═══ SCENE: The reveal (42-46s / frames 1650-1740) ═══ */}
      <Fade startAt={heygenEnd} endAt={1740} fadeIn={15} fadeOut={15}>
        <AbsoluteFill style={{
          background: '#0A0604',
          ...
          <div style={{
            ...
            opacity: interpolate(frame, [heygenEnd + 15, heygenEnd + 30], [0, 1], {
          ...
          <div style={{
            ...
            opacity: interpolate(frame, [heygenEnd + 40, heygenEnd + 55], [0, 1], {
              extrapolateLeft: 'clamp', extrapolateRight: 'clamp',
            }),
          }}>
      ...
      {/* ═══ END CARD (46-50s / frames 1740-1800) ═══ */}
      <Fade startAt={1740} endAt={1800} fadeIn={12} fadeOut={0}>
        <AbsoluteFill style={{
          ...
          <div style={{
            ...
            opacity: interpolate(frame, [1755, 1770], [0, 1], {extrapolateLeft: 'clamp', extrapolateRight: 'clamp'}),
            transform: `scale(${interpolate(frame, [1755, 1770], [0.8, 1], {extrapolateLeft: 'clamp', extrapolateRight: 'clamp'})})`,
          }}>
            Porizo
          </div>
          <div style={{
            fontFamily: fonts.body, fontSize: 22, color: colors.textSecondary,
            opacity: interpolate(frame, [1775, 1790], [0, 1], {extrapolateLeft: 'clamp', extrapolateRight: 'clamp'}),
          }}>
            Your moment, in a song.
          </div>
          <div style={{
            marginTop: 20,
            opacity: interpolate(frame, [1795, 1810], [0, 1], {extrapolateLeft: 'clamp', extrapolateRight: 'clamp'}),
          }}>
            <div style={{
