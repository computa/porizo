...
config service-boundary extraction.
...
```
   ...
   routes/ (28.6k LOC) ─▶│  business logic + inline SQL + provider calls│  ⚠ mixed controller layer
                         ...
                         ┌───────────────▼─────────────────────────────┐
   services/ (28.0k LOC)▶│  domain logic + inline SQL (193 simple hits) │  ⚠ partial repository layer
